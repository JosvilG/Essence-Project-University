...
public class PlayerControl : MonoBehaviour
{
    ...
    public static bool InventariActive = false;
    ...
    public static bool potVolar = false; 
    ...
    void Update()
    {
        ...
        if (ControlEscena.currentScene == "Mapamundi")
        {
            potVolar = true;
            anim.SetBool("potVolar",true);
        }
            //ActivaMenu
            ...
            //ActivaMenu
            if (Input.GetKeyDown(KeyCode.I) && InventariActive == true)
            {
                DesactivaInventari();

            }

            else if (Input.GetKeyDown(KeyCode.I) && InventariActive == false)
            {
    ...
    private void DesactivaInventari()
    {
        Time.timeScale = 1;
        Inventari.SetActive(false);
        InventariActive = false;
        MenuInGame.SetActive(false);
        MenuActive = false;
        Debug.Log("desact");
    }

    private void ActivaInventari()
    {
        Debug.Log("Pausa");
        Time.timeScale = 0;
        Inventari.SetActive(true);
        InventariActive = true;
        MenuInGame.SetActive(true);
