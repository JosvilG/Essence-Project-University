...
public class EnemicControler : MonoBehaviour
{
    ...
    public void MuerteEnemigo()
    {
        ...
        Debug.Log("Mort enemic: " + conta);
        if (conta == true)
        {
            Debug.Log("Pre conta - Mort enemic2: " + conta + " Morts: "+contadorMorts);
            contadorMorts++;
            Debug.Log("Post conta - Mort enemic2: " + conta + " Morts: " + contadorMorts);
            Debug.Log("Contador morts: " + contadorMorts);
